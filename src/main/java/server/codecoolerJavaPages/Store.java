...
public class Store implements HttpHandler {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        List<Artifact> teamsList = codecoolerDAO.readArtifacts();
        int userId = 0;
    ...
    private void sendResponseIfUserExists(HttpExchange httpExchange, CodecoolerModel codecoolerModel, List<Artifact> artifactList) throws IOException {
        // get a template file
        JtwigTemplate template = JtwigTemplate.classpathTemplate("HTML/codecoolerPages/store.twig");
        // create a model that will be passed to a template
        JtwigModel model = JtwigModel.newModel();
        fillModelTwig(model, codecoolerModel, artifactList);
    ...
    private void fillModelTwig(JtwigModel model, CodecoolerModel codecoolerModel, List<Artifact> artifactList ){
