...
public class ClassAdder implements HttpHandler {
    ...
    public ClassAdder(Connection connection){
    ...
    private String generatePage(String sessionId){
        ...
        // get a template file
        JtwigTemplate template = JtwigTemplate.classpathTemplate("HTML/adminPages/classAdder.twig");
